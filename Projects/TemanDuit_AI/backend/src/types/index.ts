...
// ============================================================
// Login Code - Kode unik untuk login dashboard
// ============================================================

export interface LoginCode {
  code: string;       // 8 karakter alfanumerik uppercase
  userId: string;
  createdAt: string;
  shownAt?: string;   // kapan kode pernah ditampilkan (sekali lihat)
  isActive: boolean;  // bisa di-regenerate via bot
}
