...
The JSON must have this structure:
{
  "analysis": {
    ...
    "technical_indicators": {
      ...
      "RSI": numeric value,
      "MACD": "trend info",
      "BollingerBands": "position info"
    },
    "support_levels": [list of numeric support levels],
    "resistance_levels": [list of numeric resistance levels],
    "confidence_level": "percentage confidence of main prediction",
    "ai_commentary": "Concise text commentary"
  },
...
3. Include confidence_level, trend_strength, technical_indicators, ai_commentary.
4. Do not include any explanations or extra text outside JSON.
5. Include all components even if some are null.
6. Provide concise, precise, and professional financial analysis.
`;
